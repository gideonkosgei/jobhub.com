...
<!------------------------start of header------------------------------------------------------------>
     ...
     <div class="details">
       <table width="200" border="0">
		...
		{
		echo"<form method='post' action='includes/js_delete_update_language.php'><tr><td>".$no."</td><td>".$lang['language']."</td><td>".$lang['js_read']."</td><td>".$lang['js_write']."</td><td>".$lang['js_speak']."</td><td><input type='hidden' value=$lang[language_id] name='lang_ID'><input type='submit' name='edit'value='edit'><input type='submit' name='delete'value='delete'></td></tr></form>";
$no++;
}
	   ?>
	   </table>
